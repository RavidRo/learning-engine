...
Define how source metadata such as images is dynamically resolved, previewed, used during update collection, and kept separate from persisted interest configuration.
